...
context('Get Data', () => {
  it('Get games from Winner',() =>{
    let siteUrl = 'https://www.winner.co.il/mainbook/sport-%D7%9B%D7%93%D7%95%D7%A8%D7%92%D7%9C/ep-%D7%90%D7%A0%D7%92%D7%9C%D7%99%D7%94/ep-%D7%A4%D7%A8%D7%9E%D7%99%D7%99%D7%A8-%D7%9C%D7%99%D7%92?date=all&marketTypePeriod=1%7C100'
    cy.visit(siteUrl)
      cy.get('.event_path-content').children().its('length').then((length) => {
        ...
        cy.task('saveJson','PremierLeagueWinner')
      })
  })
})